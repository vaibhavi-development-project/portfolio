...
export const projects: Project[] = [
  {
    ...
    description:
"Modern furniture showcase platform with admin management and real-time updates.",
 image: project1,
  tags: ["React", "Framer Motion", "Node.js",  "TypeScript"],
    category: "Frontend & UI/UX",
    demo: "https://dynamicfurniture-showcase.vercel.app/login",
  ...
  },
  {
    ...
    description:
"A real-time food rescue platform for surplus meal listing and booking.",
    image: project2,
    tags: ["React", "TypeScript", "JWT","Radix UI"],
    category: "Frontend & UI/UX",
    demo: "https://re-plate-mnk2.vercel.app/",
    code: "https://github.com/vaibhavi-development-project/RePlate",
  },
  {
    title: "NexaCollab – Where work flows and teams align",
    description:
      "A full-stack workspace collaboration platform with RBAC and real-time features.",
    image: project3,
    tags: ["Express.js","MongoDB", "Node.js", "Cloudinary"],
    category: "Full Stack",
    demo: "https://nexacollab-one.vercel.app/",
    code: "https://github.com/vaibhavi-development-project/NexaCollab",
  },
  {
    title: "CourseHub – Learning Management System",
    description:
"A learning management system with course management and student enrollment features.",
    image: project4,
    tags: ["Node.js", "Express", "React","MongoDB"],
    category: "Full Stack",
    demo: "https://coursehub-platform-prj.vercel.app/",
